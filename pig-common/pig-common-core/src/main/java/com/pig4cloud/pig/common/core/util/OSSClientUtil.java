...
public class OSSClientUtil {
    ...
    private static String accessKeyId="LTAIYQmA2I8gRj4W";
    ...
    private static String accessKeySecret="3XPC0U3n8X1cbDVNSg0Zu3ZoXxpJm1";
    /** 阿里云API的内或外网域名 */
    private static String endpoint="http://oss-cn-beijing.aliyuncs.com";
    /** 阿里云API的bucket名称 */
    private static String bucketName="shenning";
    /** 阿里云API的文件夹名称 */
