...
Date: 2019-06-21 17:49:23
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for sup_main_filing
-- ----------------------------
DROP TABLE IF EXISTS `sup_main_filing`;
CREATE TABLE `sup_main_filing` (
  `id` int(20) NOT NULL AUTO_INCREMENT,
  `sup_name` varchar(36) DEFAULT NULL COMMENT '供应商名称',
  `sup_creditcode` varchar(64) DEFAULT NULL COMMENT '社会信用代码',
  `cor_name` varchar(32) DEFAULT NULL COMMENT '法人姓名',
  `link_name` varchar(32) DEFAULT NULL COMMENT '联系人姓名',
  `contact` varchar(32) DEFAULT NULL COMMENT '联系方式',
  `sup_type` varchar(2) DEFAULT NULL COMMENT '供应商类型(1有限责任公司 2股份有限公司 3个人独资企业 4合作企业 5个体工商户)',
  `area_code` varchar(32) DEFAULT NULL COMMENT '所属区划号',
  `addr` varchar(255) DEFAULT NULL COMMENT '地址',
  `phone` varchar(32) DEFAULT NULL COMMENT '手机',
  `zip_code` varchar(32) DEFAULT NULL COMMENT '邮编',
  `bulicense_pic` varchar(255) DEFAULT NULL COMMENT '营业执照照片',
  `permit_pic` varchar(255) DEFAULT NULL COMMENT '许可证照片',
  `else_pic` varchar(255) DEFAULT NULL COMMENT '其它证照片',
  `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `del_flag` char(1) DEFAULT '0' COMMENT '是否删除  -1：已删除  0：正常',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='供应商备案表';

-- ----------------------------
-- Records of sup_main_filing
-- ----------------------------
INSERT INTO `sup_main_filing` VALUES ('1', '1234', null, '12412312', null, null, null, null, null, null, null, null, null, null, null, '2019-06-21 15:16:22', '2019-06-21 15:16:29', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='系统角色表';
...
CREATE TABLE `sys_role_dept` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='角色与部门对应关系';
...
-- ----------------------------
-- Table structure for sys_sn
-- ----------------------------
DROP TABLE IF EXISTS `sys_sn`;
CREATE TABLE `sys_sn` (
  `id` int(36) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(36) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '姓名',
  PRIMARY KEY (`id`)
...
-- Records of sys_sn
-- ----------------------------
INSERT INTO `sys_sn` VALUES ('1', '张三');
INSERT INTO `sys_sn` VALUES ('2', '李四');
INSERT INTO `sys_sn` VALUES ('13', '王五');
